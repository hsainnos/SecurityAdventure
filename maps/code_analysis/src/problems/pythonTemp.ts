...
$(function() {
    ...
    codeAnalysisObject.createProblem(codeContainer,LEVEL_CONSTANTS.LEVEL_2.pythonTemp.variableName,"python","import tempfile\n" +
        ...
        "\n",[{answer : "risk of malicious code execution", isRight: false},{answer : "higher risk comes with higher permissions", isRight: false},{answer : "risk of altering files", isRight: true},{answer : "risk of buffer overflow", isRight: false}],"mktemp() creates a temporary file.\n" +
        "\n" +
        "import tempfile\n" +
        "name=tempfile.mktemp()\n" +
        "\n" +
