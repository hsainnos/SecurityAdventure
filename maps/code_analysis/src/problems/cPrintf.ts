...
$(function() {
    ...
    codeAnalysisObject.createProblem(codeContainer,LEVEL_CONSTANTS.LEVEL_2.cprinf.variableName,"clike","#include <stdio.h>\n" +
        ...
        "  warning)\n" +
        "sprintf.c:5:21: Unrecognized identifier: string\n",[{answer : "malicious code execution", isRight: false},{answer : "risk of data breach", isRight: false},{answer : "undefined behaviour", isRight: false},{answer : "buffer overflow", isRight: true}],"Sprintf() prints a formatted string.\n" +
        "\n" +
        "sprintf(str, \"%s\", string);\n" +
        "\n" +
        "\n" +
